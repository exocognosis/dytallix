# Clippy Report — Errors: 77, Warnings: 32
...
note: method defined here
   --> node/src/storage/tx.rs:76:12
    |
76  |     pub fn with_gas(mut self, gas_limit: u64, gas_price: u64) -> Self {
    |            ^^^^^^^^ --------
...
error: could not compile `dytallix-lean-node` (lib test) due to 3 previous errors
...
error: could not compile `dytallix-lean-node` (lib) due to 72 previous errors
