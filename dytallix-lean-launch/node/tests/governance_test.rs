...
fn test_governance_voting_flow() {
    ...
    // Cast votes
    governance.vote(450, "voter1", proposal_id, VoteOption::Yes).unwrap();
    governance.vote(451, "voter2", proposal_id, VoteOption::Yes).unwrap();
    governance.vote(452, "voter3", proposal_id, VoteOption::No).unwrap();
