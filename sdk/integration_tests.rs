...
use crate::{PQCWallet, PublicKeyProto};
use anyhow::Result;
use serde_json::json;
...
// Note: This file is included as a test-only module by lib.rs
// Tests below exercise end-to-end signing and validation flows.
