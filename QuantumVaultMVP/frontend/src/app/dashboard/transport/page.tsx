...
export default function TransportPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setError('Failed to load secure transport metrics from the server.');
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="p-6 lg:p-8 space-y-6">
            ...
            {loading ? (
                <div className="text-white/40 text-center animate-pulse p-12">Loading secure transport data...</div>
            ) : (
                <>
                    {/* Metrics Row */}
