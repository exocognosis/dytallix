        ...
        <GlassPanel variant="card" hoverEffect={true} className="space-y-6 p-6">
            ...
            <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {DATA_TYPES.map(type => (
                        <label key={type} className="flex items-start space-x-3 p-3 rounded-lg border border-input bg-background cursor-pointer">
                            <input
                                type="checkbox"
            ...
            <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {CRYPTO_OPTIONS.map(crypto => (
                        <label key={crypto} className="flex items-start space-x-3 p-3 rounded-lg border border-input bg-background cursor-pointer">
                            <input
                                type="checkbox"
