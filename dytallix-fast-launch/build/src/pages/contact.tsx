        ...
        <Section title="Get in Touch" subtitle="Have questions? We'd love to hear from you.">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                    <a href="mailto:hello@dytallix.com" className="block cursor-pointer">
                    ...
                    <a href="https://t.me/dytallix" target="_blank" rel="noopener noreferrer" className="block cursor-pointer">
                        <GlassPanel hoverEffect={true} className="p-6 flex items-center gap-4">
                            <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">https://t.me/dytallix</p>
                            </div>
                        </GlassPanel>
                    </a>

                    <a href="https://x.com/DytallixHQ" target="_blank" rel="noopener noreferrer" className="block cursor-pointer">
                        <GlassPanel hoverEffect={true} className="p-6 flex items-center gap-4">
                            <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">@DytallixHQ</p>
                            </div>
                        </GlassPanel>
                    </a>
                </div>
