...
impl ConsensusEngine {
    ...
    async fn validate_deploy_transaction_basic(
        ...
        let gas_cost: crate::types::Amount = (deploy_tx.gas_limit as crate::types::Amount)
            .saturating_mul(deploy_tx.gas_price as crate::types::Amount);
    ...
    async fn validate_call_transaction_basic(
        ...
        let gas_cost: crate::types::Amount = (call_tx.gas_limit as crate::types::Amount)
            .saturating_mul(call_tx.gas_price as crate::types::Amount);
        let total_cost = gas_cost.saturating_add(call_tx.value);
