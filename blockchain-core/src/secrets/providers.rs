...
impl SecretProvider for EnvProvider {
    ...
    fn get_info(&self) -> HashMap<String, String> {
        ...
        info.insert("case_sensitive".to_string(), self.case_sensitive.to_string());
        info
    }
}
...
impl VaultProvider {
    ...
    pub fn from_env() -> SecretResult<Self> {
        ...
        let mount_path = env::var("DYTALLIX_VAULT_MOUNT")
    ...
    fn populate_stub_data(&mut self) {
        ...
        self.stub_data.insert(
            format!("{}/database/port", base_path),
            "5432".to_string()
        );
        self.stub_data.insert(
        ...
        self.stub_data.insert(
            ...
            if self.environment == "dev" { "debug" } else { "info" }.to_string()
        );
        self.stub_data.insert(
