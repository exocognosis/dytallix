...
use blockchain_core::policy::{SignaturePolicy, PolicyManager, PolicyError};
...
mod signature_policy_tests {
    ...
    fn test_policy_manager() {
        ...
        assert!(manager.validate_transaction_algorithm(&SignatureAlgorithm::Falcon1024).is_ok());
...
mod integration_tests {
    ...
    fn test_mempool_policy_integration() {
        ...
        let result = restrictive_manager.validate_transaction_algorithm(&SignatureAlgorithm::Dilithium5);
    ...
    fn test_consensus_policy_integration() {
        ...
        assert!(policy_manager.validate_transaction_algorithm(&SignatureAlgorithm::Dilithium5).is_ok());
        assert!(policy_manager.validate_transaction_algorithm(&SignatureAlgorithm::Falcon1024).is_ok());
        assert!(policy_manager.validate_transaction_algorithm(&SignatureAlgorithm::SphincsSha256128s).is_ok());
    }
}