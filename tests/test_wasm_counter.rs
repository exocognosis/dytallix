...
async fn test_wasm_counter_flow() {
    ...
    println!("✓ Mock deployment: address={}, gas_used={}", mock_address, mock_gas_used);
...
fn test_counter_get() {
    ...
    println!("✓ Counter get: value={}, gas_used={}", mock_value, mock_gas_used);
}
...
async fn test_wasm_gas_metering() {
    ...
    if gas_used > gas_limit {
        println!("✓ Gas limit enforcement: used {} > limit {}", gas_used, gas_limit);
    }
